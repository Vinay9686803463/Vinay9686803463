...
- **C++** — Programming, OOP, problem solving, Data Structures & Algorithms
...
- **HTML5** — Semantic HTML, webpage structure
- **CSS3** — Styling, layouts, responsive design
- **JavaScript** — Programming, DOM manipulation, web development
